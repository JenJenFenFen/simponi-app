...
Route::get('/cek-mahasiswa', [AdminController::class, 'cekMahasiswa'])->name('cekMahasiswa');

Route::post('/fetch-mahasiswa', [AdminController::class, 'fetchMahasiswa'])->name('fetchMahasiswa');

Route::get('/cek-dosen', [AdminController::class, 'cekDosen'])->name('cekDosen');

Route::post('/fetch-dosen', [AdminController::class, 'fetchDosen'])->name('fetchDosen');