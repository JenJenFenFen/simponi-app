        ...
        <div class="px-4 pb-[30px] mt-14">
            ...
            <div class="grid grid-cols-12 gap-4 mb-6">
                <div class="col-start-1 col-end-4">
                    ...
                    <input type="text" id="nama_kelas" class="bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 uppercase border-gray-300" maxlength="4">
            ...
            <form method="POST" action="" id="form_daftar_kelas" enctype="multipart/form-data">
                ...
                <div class="flex items-start mt-6">
                    ...
                    <label for="remember" class="ml-2 text-sm font-medium text-gray-200">Semua data kelas yang diisi sudah benar.</label>
                </div>
