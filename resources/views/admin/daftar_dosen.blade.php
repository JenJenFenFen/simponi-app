...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-black border-dashed rounded-lg mt-14">
            ...
            <form id="form_daftar_dsn">
                ...
                <div class="page" id="page1">
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <label for="kota_pt_dsn" class="block mb-2 text-sm font-medium text-gray-900">Kota Pendidikan Terakhir</label>
                            <input type="text" id="kota_pt_dsn" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            <span class="font-medium mt-2 text-sm text-red-600" hidden>Masih kosong! Silakan diisi!</span>
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="foto_dsn" class="block mb-2 text-sm font-medium text-gray-900">Foto</label>
                            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="file_input" type="file" required>
                            <span class="font-medium mt-2 text-sm text-red-600" hidden>Masih kosong! Silakan diisi!</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="page" id="page2" hidden>
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <label for="nid_dsn" class="block mb-2 text-sm font-medium text-gray-900">Nomor Induk Dosen</label>
                            <input type="text" id="nid_dsn" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" value="123" disabled readonly>
                        </div>
                        <div class="relative">
                ...
                <div class="page" id="page3" hidden>
                    <div>
                        <div>
                            <label for="foto_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Foto</label>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="nama_lengkap_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="tempat_lahir_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Tempat Lahir</label>
                            <input type="text" id="tempat_lahir_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="tanggal_lahir_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Tanggal Lahir</label>
                            <input type="date" id="tanggal_lahir_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div> 
                        <div>
                            <label for="ktp_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">KTP</label>
                            <input type="text" id="ktp_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="agama_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Agama</label>
                            <input type="text" id="agama_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="pendidikan_terakhir_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Pendidikan Terakhir</label>
                            <input type="text" id="pendidikan_terakhir_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="sekolah_pt_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Sekolah Pendidikan Terakhir</label>
                            <input type="text" id="sekolah_pt_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="kota_pt_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Kota Pendidikan Terakhir</label>
                            <input type="text" id="kota_pt_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="alamat_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Alamat</label>
                            <input type="text" id="alamat_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="email_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                            <input type="text" id="email_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="no_hp_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">No Handphone</label>
                            <input type="text" id="no_hp_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="program_studi_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Program Studi</label>
                            <input type="text" id="program_studi_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="jabatan_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Jabatan</label>
                            <input type="text" id="jabatan_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="tgl_bergabung_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Tanggal Bergabung</label>
                            <input type="text" id="tgl_bergabung_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                        <div>
                            <label for="nid_dsn_val" class="block mb-2 text-sm font-medium text-gray-900">Nomor Induk Dosen</label>
                            <input type="text" id="nid_dsn_val" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" disabled readonly>
                        </div>
                    </div>
